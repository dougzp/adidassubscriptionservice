...
import com.douglas.service.registerService.entities.GenderEnum;
...
public class SubcriptionRegisterApplicationTests {
	...
	public void checkDataBaseRegisters() {
		...
		repostiory.save(new SubscriptionEntity("dougzp@gmail.com","dougzp@gmail.com", new Date(), GenderEnum.MALE, true));
		repostiory.save(new SubscriptionEntity("dougteste@gmail.com","dougzp@gmail.com", new Date(), GenderEnum.MALE, true));
